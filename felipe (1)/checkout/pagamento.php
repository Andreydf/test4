...
// Configurações
$secretKey = "sk_PuAr__W3OPuD3Jnjrb4YtymoZrVxW-hYg1eLkRA6GK6NdS3I";
...
try {
    ...
    $valor = isset($_GET['valor']) ? intval($_GET['valor']) : 7340; // Valor padrão de 2790 centavos se não for especificado
